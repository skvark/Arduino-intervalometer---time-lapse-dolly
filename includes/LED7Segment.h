...
// Modifications by Olli-Pekka Heinisuo
// 15 June 2011
// http://unknownpixels.com

// Added characters 128-132 and 133-137, animates 'Error' on 2-digit 7 segment display

#include "WProgram.h"

const byte ledCharSet[138] = {
	// 00-0F: Hex digits
